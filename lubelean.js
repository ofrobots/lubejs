  ...
  if (peek == _0) {
    ...
    switch (r) {
      ...
      case _x:
         ...
         this . ltval = parseInt ( this .ltcontents = l.slice(this.c,c) ) ; 
         this.c = c;
         return;
      ...
      case _b:
        ...
        while ( c < e && ( r = l . charCodeAt(   ++  c )  , r == _0 || r == _1 ) ) { v<<= 1; v |= (r- _0 ) ; }
        this. ltval = v ;
        this. ltcontents  = l.slice(this.c,c)  ;
        this.c=c; 
        return  ;
      ...
      default:
       if ( r >= _0 && r <= _9 ) {
          ...
          if ( v == 0 ) v = 8 ;
          this.ltval = parseInt ( this . ltcontents = l.slice(this.c, c), v );
          this.c=c;
          return ;
       }
       else {
    ...
    this.c = c;
    if ( this.frac(v) ) return;
    else this.ltval = parseInt(this.ltcontents = l.slice(v, this.c)  ) ;
    this.c = c;
  }
...
lp . frac = function(n) {
  ...
  this.ltcontents = l.slice (n === -1 ? this.c - 1 : n, c);
  this.ltval =  parseFloat(this.ltcontents )  ;
  this.c = c ;
  return ! false   ;
}
...
lp.readStrLiteral = function (start) {
  ...
  this.lttype = 'Literal'  ;
  this.ltcontents =  l.slice (this.c0, this.c);
  this.ltval = v ;
};
...
lp . readEsc = function ()  {
  ...
  switch ( l.charCodeAt ( ++ this.c ) ) {
   ...
   case _x :
      e0 = toNum(l.charCodeAt ( ++this.c));
      if ( e0  === -1  ) this.err ( l[ this.c]   + ' is not a valid hex'   )  ;
      e  = toNum(l.charCodeAt ( ++this.c));
      if ( e   === -1  ) this.err ( l[ this.c] + ' is not a valid hex   ' ) ;
   ...
   case _3:
       ...
       if ( this. tight ) {
          if ( e0 == _0 ) { e0 = l.charCodeAt(this.c +  1);
          if ( e0 < _0 || e0 >= _8   ) return '\0'  ;   }
       ...
       if ( e0 >= _0 && e0 < _8 ) {
          this.c++; e <<= 3 ; e += (e0-_0);
          e0 =  l.charCodeAt(this.c  +  1); 
          if ( e0 >= _0 && e0 < _8 ) { this.c++ ; e<<= 3; e  += (e0-_0); }
       }
       return String.fromCharCode(e)  ;
...
lp.parseIfStatement = function () {
  ...
  this.next () ;
  this.expect('(');
  var _t = core ( this.parseExpr(null,0) ) ;
  this.expect(')' );
...
lp.parseContinueStatement = function () {
  ...
  this.next   () ; 
  if ( !this.hasL && this.lttype === 'Identifier' ) {
     _l = this. id ();
     var l = _l .value  + '%' ;
     if ( !has.call (this.lbn, l) || this.lbn[l] == -1   ) this.err( 'Label is not def ' + ( _l .value ) ) ;
...
lp.parseSwitchStatement = function () {
  ...
  this.next    () ;
  this.expect('(');
  var  _d  = core ( this.parseExpr(null,0) ) ;
  this.expect ( ')' ) ;
  this.expect('{');
  this.scopeFlags |= ( breakFlag ) ;
...
lp.parseReturnStatement = function () {
  ...
  this.next   () ; 
  if ( ! this.hasL && ( _l = this. parseExprHeadOrYield(0) ) )  {
     _l = this.parseExpr(_l,0 );
     i  = this.semiI()   || _l .end   ;
     eLoc = this.semiLoc() || _l.loc.end;      
  }
  else  {
...
lp.parseThrowStatement = function () {
  ...
  this.next   () ; 
  if ( ! this.hasL && ( _a = this. parseExprHeadOrYield(0) ) )  {
     _a = this.parseExpr(_a ,0 );
     i  = this.semiI()   || _a . end   ;
...
lp.parseTryStatement = function () {
  var startc = this.c0, startLoc = this.locBegin   () ;
  this.next() ;
  var _b  = this.parseBlckStatement( !false  ) ;
  var _e  = null, _h = null;
...
lp . parseWithStatement = function() {
   ...
   this.next   () ; 
   this.expect('(' );
   var _o = this. parseExpr(null,0 ), _b ;
   this.expect(')' );
   var _b = this.parseStatement ( ! false  ); 
   return  {
         type : 'WithStatement',
...
//        default:if ( o >= 0x0D800 && o <= 0x0DBFF ) { this.col-- ; }
     ...
     n. regex . flags = l.slice(c-o, c) ;
     n. regex . pattern = n.contents = l.slice(this.c, c-o -( 1 ) ) ; 
...
lp.parseArrayExpression = function (cFlags_Sh_Non ) {
  ...
  while ( !false ) {
    ...
    else if ( this.ltcontents === ',' )  e . push ( null ) ;
...
lp . parse_let=function() {
  ...
  if ( startStmt ) this.startStmt = false ;
  return createIDLoc ( startc, startLoc, c, col,  li,   'let'      )  ;
}
     ...
     switch ( nexpr. type ) {
       case 'Identifier' :
         if ( isB ) {
            ...
            this. validateID (  nexpr   . value   )  ;
            this. arg ( nexpr , !false)  ;
         }
         else if ( this. tight && this. argE ( nexpr   . value   )  ) this. err ( nexpr   . value + ' is not an assig '   )  ;
       ...
       case 'ArrayPattern' : 
          if ( isB ) {       nexpr . type = 'ArrayExpression' ;   return this.convAssig ( nexpr , isB )   ;   }
          this. err(   'ArrayPattern is an assig ' )  ;
        ...
        case 'ObjectPattern' :
          if ( isB ) {       nexpr . type = 'ObjectExpression' ;   return this.convAssig ( nexpr , isB )   ;   }
          this. err(    ' ObjectPattern  is an assig ' )  ;
       ...
       case 'AssignmentExpression':
         ...
         if ( nexpr. type !=    'AssignmentExpressionB'   )  {  
          if ( nexpr . operator  != '=' ) {
              this.convErr = 'found ' + nexpr . operator + 'not = ' ; 
              return nexpr ;
          } 
         ...
         convErr = null ;
         if ( isB ) convErr = this.convAssig ( nexpr . left, isB ) ;
         if ( !convErr ) nexpr . type = 'AssignmentPattern' ;
         return convErr ;

       case 'AssignmentPattern' :
          if ( isB ) { nexpr . type = 'AssignmentExpressionB'   ;     return this.convAssig ( nexpr , isB )  ;   }
          this. err ( 'AssignmentPattern is an assig    '   )  ;         
       ...
       case  'RestElement'   :
          if ( isB ) {           nexpr . type = 'SpreadElement' ; return this.convAssig ( nexpr , isB )  ; }
          this.err (      'RestElement is an assig  '        )  ;
...
lp.parseArgList = function () {
    var n = [], e ;
    while ( !false ) {
       if ( e = this. parseExprHeadOrYield () ) { n. push (core ( this. parseNonSeqExpr ( e, 0, 0) ) ) ; }
       else if ( this.  ltcontents == '...' ) { n. push( this. parseSpreadElement () ) ; }
       else break ;
...
lp.parseParen = function () {
  var startc = this.c - 1, startLoc = this.locOn   (  1 )  ;
  this.next   () ;
  var e = this.parseExpr   ( null, 0 ) ;
  e. pDepth ++ ;

  var n = { type  : 'paren', expr  : e,  start  : startc,
             end  : this.c,
           loc    : { start : startLoc, end  : this.loc   () } }  ;
     ...
     do { 
         ...
         if ( cFlags_For ) {
           switch ( this. idcontents ) {
             case 'in' :
             case 'of' :
                if ( dec.length > 1 )  this.err ( _head . kind + ' must not have more than one decl in case it is in a for/in' ) ;
                if ( this. v > 5 && dec [ 0 ] .init   )
                     this. err ( 'must not have init '   )  ;
...
lp . parseVariableDeclarator = function(cFlags_For ) {
   ...
   if ( n ) {
       ...
       if ( this. ltcontents   == ('=' ) )  {
          this.next   () ; 
          _i  =  this. parseNonSeqExpr(this.parseExprHeadOrYield(0  ),0, cFlags_For );
       }
       else if  ( n.  type !=  'Identifier' ) {
         if (  !cFlags_For  ||  
                  (  this. idcontents != ( 'in' ) &&  this. idcontents !=  ( 'of' )   )  ) {
            this. err ( ' no ' )  ;
...
lp . parseFor = function() {
  ...
  switch ( _in   =  this.    idcontents ) {
     ...
     case 'in' :
       ...
       _in = (  _in == ( 'of' )   )  ?                              'ForOfStatement' : 'ForInStatement'   ;
     ...
     default :
        ...
        if ( this. propThatMustBeInAnAssig ) {
           this.canHaveNoAssig = false ;
           _head = this.parseExpr(_head , 0 ) ;
        }
        this. expect (';'); 
        if ( this.ltcontents != ';' ) _mid = core( this. parseExpr(null,0));  
        this.expect(';');
        _tail = this. parseExprHead(0);
        if( _tail )_tail = core( this.parseExpr (_tail, 0 ) );
        else _tail = null; 
    }
    this. expect ( ')' ) ;
    ++ this. iteD ;
    ...
    return _in ?
          { type: (  _in   )  , loc: { start : startLoc, end : _b.loc.end },
            start : startc, end: _b.end, right : _mid, left: core( _head ), body: _b } :
          { type: 'ForStatement', init: ! _head ? _head :  core(_head ), start : startc, end: _b.end, test : _mid,
             loc: { start : startLoc, end: _b.loc.end }, update: _tail, body: _b };
}
...
lp.parseProperty = function (cmn) {
  ...
  while ( !false ) 
    switch ( n ) { 
      case 'get':
        ...
        if (e = this.parseMemName()) {
           ...
           if ( cmn != METHD ) { 
             n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                     kind: 'get', computed: e.type ==='[',
                     loc : loc,  method : false, shorthand : false, value : _v };
             this. mustNot = !false ;
           }
           else  {
             if ( e. value == 'constructor'   ) this. err ( 'constructor: get'   )  ;

             n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                     kind: 'get', computed: e.type ==='[',
                     loc : loc, static: _static,  value : _v  };
           }
           return n   ;
        }
      ...
      case 'set':
        ...
        if (e = this.parseMemName()) {
           ...
           if ( cmn != METHD ) {
             n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                     kind: 'set' , computed: e.type ==='[',
                     loc : loc,  method : false, shorthand : false,  value :  _v };       
             this. mustNot = !false ;
           }
           else  { 
             if ( e. value == 'constructor' ) this. err ( 'constructor     no   '      )   ;
        ...
        e  = _static ? createID    (c0,col0,c,col,li,'set') :
                       createIDLoc (startc,startLoc,c,col,li,'set');
        break L;
      ...
      case '*':
        ...
        if ( cmn != METHD ) { 
          n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                  kind: 'init', computed: e.type ==='[', 
                  loc : loc,  method : ! false, shorthand : false , value : _v  }; 
          this. mustNot = !false ; 
        }                                                      
        else  {
          if ( e. value == 'constructor' ) this.err ( ' constructor can not be * ' )  ;  
          n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                  kind: 'method', computed: e.type ==='[',
                  loc : loc, static: _static, value : _v  };
        }
        return n   ;
    ...
    default: 
        ...
        if ( _static ) { e = createIDLoc( startc, startLoc, c, col, li, 'static'); break L ; } 
        return;
  }

  switch (this.lttype) {
    case '(':
       if ( !startLoc ) { startc = e.start; startLoc = e.loc.start;  }
       ...
       if ( cmn != METHD ) {
         ...
         n  =  { type: Prop, key: coreP (e), start : startc, end: _v.end,
                 kind:   (_static || e. value != 'constructor' )  ?  'method'                   :              (   'constructor'   )          , computed: e.type ==='[',
                 loc : loc, value : _v   ,  static: _static   };
       }
       return n   ;
     ...
     case ':':
       ...
       return {  type: 'Property',  start : e.start , key :  coreP (e) ,  end : _v . end , kind: 'init',
                loc : { start : e.loc.start, end : _v . loc. end   }  , computed: e . type == '[',
                method : false , shorthand : false , value : core(_v) };
...
lp . validateArg = function ( r ) {
  ...
  for ( e in r ) {
     ...
     this. validateID ( e = e.substr( 0, e.length - 1  ) )  ;
     if ( this. argE  (e  )  )
        this. err ( e + ' is not an arg           '   )   ;
...
lp.parsePattern = function() {
  switch ( this.lttype ) {
    case 'Identifier' : return  this. validateID   ( null  )    ;
...
lp . argE             = function(l ) { switch ( l ) { case 'arguments': case 'eval' : return !false ; } return false   ;  } 
lp.parseObjectPattern  = function() {
    ...
    while ( n = this. parseMemName() ) {
        ...
        e  . push ({ type: 'Property', start : n.start, key: coreP (n), end: v.end , loc: { start : n.loc.start , end: v.loc.end },
             kind: "init" , computed: n. type == '[', value : v, method : false , shorthand : sh  }); 
        if ( this.ltcontents == ',' ) { this.next (); continue; }
...
lp . parseArgs  = function (argLen ) {
  ...
  if ( argLen && argLen != -1 && this.ltcontents == '...') { e. push (this. parseRestElement () ) ; }
  this.expect(')' );
...
lp . parseFunc   = function( cFlags_For  ) {
  var startStmt = this.startStmt, startc = this.c0,            startLoc = this.locBegin   () , _i = this. i  , isGen = false ;
  var scopeFlags = this. scopeFlags ;
  ...
  if ( startStmt )  {
     this.startStmt = false;
     if ( this. lttype == 'Identifier' ) this. i = this. id   () ; 
     else
        this.err( 'Unexpected ' + this. lttype   )  ;
  }
  else if ( this. lttype == 'Identifier' )  { this.  i = this. id(); }
  else this. i = null ;

  this.scopeFlags = 0 ;
  var _a = this. parseArgs( -1  ) ;
  var _b = this. parseFuncBody( !isGen ?  cFlags_For  : cFlags_For | cfY , scopeFlags   )  ;
  var n =  { type : ( startStmt ?  'FunctionDeclaration' : 'FunctionExpression' ) ,
            id : this. i  ,
         start : startc   ,
           end : _b . end , 
           generator      : isGen , 
...
lp.parseFuncBody = function(      cFlags_For_Y, scopeFlags                    ) {
     ...
     if ( this. ltcontents != '{' ) 
        return this.parseNonSeqExpr( this. parseExprHeadOrYield (0) || this.err('Unexpected ' + ((this).ltcontents)), 0, cFlags_For_Y );
 
     if ( scopeFlags & methdFlag ) {
       if ( scopeFlags & funcFlag ) this.scopeFlags = funcFlag ;
       else this.scopeFlags = ( methdFlag | funcFlag ) ;
     }
     else this.scopeFlags = funcFlag ;
    
     if ( cFlags_For_Y & cfY ) this.scopeFlags |= yieldFlag ;
     ...
     if ( stmt ) {
        if ( this. v > 5 && stmt. type == 'ExpressionStatement' && ( stmt. expression . type == 'Literal') )
          switch (this.src.slice(stmt.expression.start,stmt.expression.end )) { 
               ...
               case '"use strict"':
                    this.tight = ! false ;
                    if ( this. i &&             this. argE ( this. i. value ) ) this. err ( this. i. value + ' can not be id in the strict '   )  ;
